var taskData = [
  ...
  // ■ フェーズ3：退職直後の手続き
  {
    ...
    description: "すでに退職済みの場合、在職中の行動によって給付の可否が決まっています。①『退職日より前に医師の診察を受けていたか』、②『退職日を含め、直前4日間以上連続して休んでいた（当日の出勤・業務連絡なし）か』をご確認ください。（※この制度は自動適用されません。退職日以前に医師の証明が必要です。退職後の申請では手遅れになる可能性があります）※原則として、少額でも『給与・報酬が発生する行為』はすべて申告対象または受給対象外と判断される可能性があります。",
  ...
  },
  {
    ...
    description: "退職後14日以内に健康保険の切り替えが必要です。<br><br><span class='risk-arrow'>→ 任意継続を希望し、退職後20日を過ぎた場合：</span><br><strong>いかなる理由でも任意継続への加入が認められなくなります。</strong><br><span class='risk-note'>※任意継続の手続きは「20日以内必着」です。</span>（※この手続きには厳格な期限があり、1日でも過ぎると一切選択できなくなります）（※この期限を過ぎると、いかなる理由があっても手続きできなくなります）（※この期限を過ぎると手続きできなくなります）",
    lossWarning: null,
    benefitInfo: null,
  ...
  },
  {
    ...
    description: "離職票を受領後、管轄のハローワークにて雇用保険の受給手続きを行います。（※申請のタイミングにより、受給開始時期や総額に大きな差が出る仕組みになっています）※原則として、少額でも『給与・報酬が発生する行為』はすべて申告対象または受給対象外と判断される可能性があります。",
  ...
  },
  {
    ...
    description: "傷病手当金が認定されなかった場合や、体調が回復した場合に備え、ハローワークで受給期間（通常1年）を最長3年延長する手続きを行っておくことが推奨されます。（※この期限を過ぎると、いかなる理由があっても手続きできなくなります）（※この期限を過ぎると手続きできなくなります）",
