var taskData = [
  ...
  },
  {
    ...
    description: "傷病手当金が認定されなかった場合や、体調が回復した場合に備え、ハローワークで受給期間（通常1年）を最長3年延長する手続きを行っておくことが推奨されます。",
  ...
  },
  {
    ...
    description: "独立・起業により雇用保険から「再就職手当」を受給する場合、自己都合退職による「給付制限」期間中に事業を開始（開業届の提出等）すると支給の対象外となります。",
